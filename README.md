...
Bank Transaction System (RESTful Backend Project)

Built a secure and scalable banking transaction backend using REST architecture, focusing on authentication, consistency, and financial data integrity.
